...
export class default1675858821956 implements MigrationInterface {
  name = 'default1675858821956';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "categories" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, CONSTRAINT "PK_24dbc6126a28ff948da33e97d3b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "specifications" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, CONSTRAINT "PK_621aabf71e640ab86f0e8b62a37" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "cars_image" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "car_id" uuid NOT NULL, "image_name" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, CONSTRAINT "PK_d51cd9b574666d7b4597fbb1604" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "specifications_cars" ("car_id" uuid NOT NULL, "specification_id" uuid NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, CONSTRAINT "REL_a9606be942c7a7983466a0aa30" UNIQUE ("car_id"), CONSTRAINT "REL_06812f537c06afbf37a9938f35" UNIQUE ("specification_id"), CONSTRAINT "PK_63472a3f9ebc2f9ea4f3e89540e" PRIMARY KEY ("car_id", "specification_id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "specifications_cars" ADD "created_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone`,
    );
    await queryRunner.query(
      `ALTER TABLE "specifications_cars" DROP CONSTRAINT "REL_a9606be942c7a7983466a0aa30"`,
    );
    await queryRunner.query(
      `ALTER TABLE "specifications_cars" DROP CONSTRAINT "REL_06812f537c06afbf37a9938f35"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "specifications_cars" ADD CONSTRAINT "FK_a9606be942c7a7983466a0aa300" FOREIGN KEY ("car_id") REFERENCES "cars"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "rentals" ADD CONSTRAINT "FK_b13ac8580bd6a011f47a476fbad" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "specifications_cars" ADD CONSTRAINT "REL_06812f537c06afbf37a9938f35" UNIQUE ("specification_id")`,
    );
    await queryRunner.query(
      `ALTER TABLE "specifications_cars" ADD CONSTRAINT "REL_a9606be942c7a7983466a0aa30" UNIQUE ("car_id")`,
    );
    await queryRunner.query(
      `ALTER TABLE "specifications_cars" DROP COLUMN "created_at"`,
    );
